...
\caption{\label{tab:unnamed-chunk-4}Hypothesis table}
\centering
\resizebox{\linewidth}{!}{
...
Hypotheses \& Specific Predictions & Related references & Overall & GPP & NPP & ANPP & BNPP & \$ANPP\_\{foliage\}\$ & ANPP woody stem & BNPP fine root & R auto root & R auto & Support\\
\midrule
\addlinespace[1em]
\hline
\multicolumn{1}{l}{\textbf{1. How do FACF vary with latitude?}}\\
...
\hspace{1em}1.2. Allocation to FACFs varies with latitude & Litton et al. (2007); DeLucia et al. (2007) & no & - & no & no & no & no & no & no & - & - & \\
\addlinespace[1em]
\hline
\multicolumn{1}{l}{\textbf{2. How do FACF relate to MAT and MAP?}}\\
\hspace{1em}2.1. FACFs increase linearly with MAT (L+) & Schuur (2003) & yes & yes & yes & yes & yes & yes & yes & yes & yes & yes & Fig. 5\\
\hspace{1em}2.2. FACFs increase with precipitation but saturate or decrease at very high levels (CD+) & Luyssaert et al. (2007); Schuur (2003) & yes & yes & yes & yes & yes & yes & () & L+ & L+ & yes & Fig. 5\\
...
\addlinespace[1em]
\hline
\multicolumn{1}{l}{\textbf{3. How do FACF relate to other annual climate variables?}}\\
...
\addlinespace[1em]
\hline
\multicolumn{1}{l}{\textbf{4. What is the role of seasonality?}}\\
...
\addlinespace[1em]
\hline
\multicolumn{1}{l}{\textbf{5. Per month of the growing seaon, how do FACF vary with climate?}}\\
