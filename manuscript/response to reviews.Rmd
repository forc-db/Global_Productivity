...
*We agree that these results are not surprising, however a crucial part of science is built on high-quality synthesis that clarifies current understanding and probes for unexpected relationships. This review under-values high-quality synthesis that produces unsurprising results.*

*As the review identifies, results from previous studies were complicated by other effects. The power of this synthesis is in how it standardises for the effects of stand age and disturbance history, unambiguously clarifying these relationships.* 
...
*Added CUE and legend to show none of the fits are significant (because of this no statistics presented)*
...
*We use MATxMAP in a linear model - clarified this in the text*
