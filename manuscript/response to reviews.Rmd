...
**Most of the points raised here are covered by more specific comments below, and our responses to these points follow those comments. The one criticism here that is not addressed below is that we present "simple statistical analyses". While we concur that the analyses are relatively simple, that does not preclude their being appropriate, informative, and sufficient. They represent several substantive advances over past analyses of this type:**
...
**We agree that these results are not surprising, however a crucial part of science is built on high-quality synthesis that clarifies current understanding and probes for unexpected relationships.**
