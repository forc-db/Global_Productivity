...
*Potentially we need a response to the "simple statistical analyses" point? - these analyses are valuable for clarifying relationships between carbon fluxes and climate. Although analyses are simple, they are powerful thanks to the coverage and extent of the dataset, and the range of fluxes examined.*
...
**To help clarify the scope of this analysis to readers, we have....**



*(let's add a few statements to emphasize how greatly the scope differs from previous studies.)*
...
**Thank you for excellent suggestion to expand the discussion of growing season length around the references given. We have re-written the paragraphs in the introduction and the discussion dealing with this issue, now citing the four references listed in the comment above.**
