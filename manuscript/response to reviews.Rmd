...
*(This is an interesting comment, and points to some more robust work on the subject of productivity and growing season length. I'm going to look up these papers. Interestingly, this links to another paper that current intern Cameron Dow is working on, which uses dendrobands to show that warmer springs shift growth earlier in the year but have at most modest effect on total productivity.)*
