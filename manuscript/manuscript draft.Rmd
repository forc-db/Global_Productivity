...
look again at breakdown of primary productivity components
  
### Introduction

Globally, forests play an important role in the carbon cycle. Old growth forests alone are estimated to sequester up to 1.4 GtCyr ^-1^ [@Malhi1999], making them a significant carbon sink, and an important component of global carbon dioxide budgets [@Luyssaert2008]. Understanding the patterns and mechanisms of forest carbon cycling on a global scale is therefore of high importance in understanding the potential role of forests in mitigating climate change.

Little is known about the main environmental drivers of these patterns.

Tropical forests alone account for around a third of terrestrial NPP (citations in Aragao 2009)
