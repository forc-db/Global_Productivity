...
Latitude is a strong predictor for many of the carbon fluxes, explaining ~65% of variation in GPP (n = 254, p<0.01), 51% in NPP (n = 116, p<0.01) and 50% in ANPP (n = 259, p<0.01).  
