...
However, our understanding of the climate dependence of forest C cycling on a global scale remains incomplete, in large part because it is pieced together from numerous studies, most considering only one or a few variables at a time, with various approaches for handling influential factors such as stand age, disturbance history, and management status [@litton_carbon_2007; @gillman_latitude_2015; @simova_enigma_2017]. 
...
Furthermore, in the tropics, climate change will push forests beyond any contemporary climate, and there are some indications that this could reduce C flux rates  [@mau_temperate_2018; @sullivan_long-term_2020] if temperature increases are paralleled by $VPD$ increases [@smith_empirical_2020].
