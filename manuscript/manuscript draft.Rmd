...
This parallels the observation that C allocation across multiple FACF varies little with respect to climate along a tropical elevational gradient [@malhi_variation_2017], 
but contrasts with observed variation in allocation along gradients of elevation [@moser_elevation_2011] 
- @gill_belowground_2016 ?
- (others in list below?)
Several trends in allocation--or lack thereof--warrant discussion.
1. CUE
2. We found a slight tendency for warmer sites to have higher aboveground allocation (Fig. S3). This is consistent with:
- [@hofhansl_new_2015] (**verify**) 
- @moser_elevation_2011 (tropical elevation gradient)
