...
The best multivariate models explained similar amounts of variation to  
...
rownames(multivariate_models) <- c("GPP", "NPP", "ANPP", "ANPP\\textsubscript{foliage}", "ANPP\\textsubscript{woody stem}", "BNPP", "BNPP\\textsubscript{root}", "R\\textsubscript{root}")
