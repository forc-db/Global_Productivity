...
That is, subsidiary fluxes may be shaped by climate both through its influence on $GPP$ and through its influence on $CUE$ and C allocation (**REF**).
...
Indeed, tree-ring studies from forests around the world indicate that tree growth rates -- along with $ANPP_{stem}$ and possibly other ecosystem C fluxes -- respond negatively to temperature [e.g., @helcoski_growing_2019; @vlam_temperature_2014]**REFS**.
