...
Some studies have detected no deceleration or decline in $GPP$ [@luyssaert_co_2007], $NPP$ [@schuur_productivity_2003], or root respiration [$R_{root}$; @wei_forest_2010] with increasing $MAT$.
...
That is, subsidiary fluxes may be shaped by climate both indirectly through its influence on $GPP$ and respiration and directly through any climatic influence on C allocation, as well as many other local- and regional-scale factors [e.g., @moser_elevation_2011] (**REFS-BECKY, know any?**).

Temperature and its seasonality were the primary drivers of C flux on the global scale (Figs. 2-4), consistent with a long legacy of research identifying temperature as a primary driver of forest ecosystem C cycling [e.g., @lieth_primary_1973; @luyssaert_co_2007; @wei_forest_2010].
...
It remains possible that flux declines above this threshold [@larjavaara_temperature_2012; @sullivan_long-term_2020], as is also consistent with tree-ring records indicating that tropical tree growth declines at high temperatures [e.g., @vlam_temperature_2014].
...
### Acknowledgements
We gratefully acknowledge all researchers who originally collected the data used in this analysis. 
...
Original compilation of the ForC database was funded by **DOE grant to KAT**.
