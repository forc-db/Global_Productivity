...
Indeed, tree-ring studies from forests around the world indicate that tree growth rates -- along with $ANPP_{stem}$ and possibly other ecosystem C fluxes -- respond negatively to growing season temperature [e.g., @helcoski_growing_2019; @vlam_temperature_2014; @martin-benito_convergence_2015; @klesse_combined_2018].
