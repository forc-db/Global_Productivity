...
Our analyses represent a major step forward in relation to previous work [@luyssaert_co_2007] in that we examine global climatic trends in more variables (9 vs. $\le$ 3), draw from a much larger database (>4 times more records analyzed), and control for the effects of stand age, disturbance, and management (not consistenly done previously).
