...
Thus, we reject the hypothesis that there is no relationship between C flux per month of the growing season and growing season climatic conditions [Table 1, *Q5*; @kerkhoff_plant_2005; @enquist_adaptive_2007; @michaletz_convergence_2014]: growing season length alone is insufficient to account for global-scale variation in productivity. 
