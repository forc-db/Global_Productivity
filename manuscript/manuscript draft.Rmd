...
The significant variation in carbon fluxes with stand age has implications for ecosystem models. Ecosystem modelling approaches may neglect age-related effects, or assume stand equilibrium [see e.g. @yu_high_2014; @collalti_forest_2020]. Our results highlight the importance of incorporating stand age into ecosystem models.

*As many dynamic global vegetation models lack age effects, such biases may be imbued in models *

**PERHAPS WE CAN BRING IN MODELING COMMENT HERE**

**Several papers note that many DVGMs don't include effects of age/assume stand equilibrium (e.g. Collalti 2020, Yu 2014) - perhaps we can note that you would expect discrepancies in model outputs if age is not accounted for?**
...
That is, subsidiary fluxes may be shaped by climate both through its influence on $GPP$ and through its influence on $CUE$ and C allocation (**REF**), as is imbued in the structure of most models [@simova_enigma_2017] **REF**.
