...
hypothesis_table[8,1] <- paste0(hypothesis_table[8,1], footnote_marker_number(10),"$^{,}$",footnote_marker_number(11)) ### fyllas nemani
hypothesis_table[10,1] <- paste0(hypothesis_table[10,1], footnote_marker_number(12),"$^{,}$",footnote_marker_number(13)) ## wagner 2016 + 2014
hypothesis_table[11,1] <- paste0(hypothesis_table[11,1], footnote_marker_number(14),"$^{,}$",footnote_marker_number(15),"$^{,}$", footnote_marker_number(16))
hypothesis_table[12,1] <- paste0(hypothesis_table[12,1], footnote_marker_number(15),"$^{,}$", footnote_marker_number(16))
hypothesis_table[13,1] <- paste0(hypothesis_table[13,1], footnote_marker_number(16))
