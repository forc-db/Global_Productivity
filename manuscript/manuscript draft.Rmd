...
| BNPP~fineroot~ | Net primary production of fine roots | Fine roots | Direct measurement of one or more of: minirhizotrons, fine root turnover, soil cores, root ingrowth cores | 96 | 88 |
...
To test for a potential influence of altitude, models were also run with site altitude included as a second fixed effect. These models were compared against models with no altitude term, and AIC values calculated to identify whether inclusion of altitude as a term improved the models.  
...
*How do carbon fluxes vary with latitude?* All major carbon fluxes increase with decreasing latitude (fig. 2). Models showed significant variation in whether they were improved by inclusion of altitude as a fixed effect. Including altitude had a very small effect on most models, with the difference in AIC values between models including and excluding altitude often being <2, suggesting the models are very similar in their explanatory power. All models presented below do not include altitude, and r-squared values refer to the proportion of variation explained by the climate variable alone.  
...
| BNPP~fineroot~ | 0.14 | 0.11 | 0.16 | 0.11 | 0.19 |
...
With the exception of ANPP~foliage~, the proportion of variation explained by climate and latitude in subsidiary fluxes is much lower. Climate explains at most 26% of variation in ANPP~woody stem~, 17% in BNPP~fine root~, and 32% in R~root~. In contrast, climate strongly explains variation in ANPP~foliage~, with mean annual temperature explaining 63% of variation.
