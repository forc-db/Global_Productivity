...
There are two key components to this question: firstly, we want to understand how forest productivity varies on a global scale, and, in particular, we want to know which regions show the highest forest productivity; and secondly, we want to understand the factors driving these patterns in productivity.  
...
In order to approach these broad and complex issues, we simplify the major gaps in our knowledge to five key questions, presented in greater detail in Table 1:  
