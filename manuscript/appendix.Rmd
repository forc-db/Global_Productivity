...
kable(S3, format = "latex", booktabs = TRUE, caption = "Table S5. Best models by carbon flux. Models where delta AIC </= 2 are presented", caption.short = "Table S5. Best models by carbon flux", escape = F) %>%
  kable_styling(latex_options = c("scale_down", "hold_position")) %>%
