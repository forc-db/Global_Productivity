...
```{r echo=FALSE, fig.cap = "Figure S3: Individual plots of FACF in relation to mean annual climate, part 1.", out.width='100%', fig.pos='H'}

  knitr::include_graphics("tables_figures/grid_plots_climate1.png")
```

\newpage
```{r echo=FALSE, fig.cap = "Figure S4: Individual plots of FACF in relation to mean annual climate, part 2.", out.width='100%', fig.pos='H'}
...
```{r echo=FALSE, fig.cap = "Figure S5: Individual plots of FACF in relation to mean climate seasonality, part 1.", out.width ='100%', fig.pos='H'}
