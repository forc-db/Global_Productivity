...
kable(S5, format = "latex", booktabs = TRUE, caption = "Table S3. Signficance of relationships of forest C fluxes to MAT alone and in combination with MAP. $R^{2}$ values refer to the best model.", escape = F)%>%
