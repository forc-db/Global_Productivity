...
kable(S1, format = "latex", booktabs = TRUE, caption = "Table S1. Climate variable definitions, sources, and abbreviations", escape = F)%>%
  ...
  kableExtra::footnote(number = c("Hijmans et al. (2005)", "Fick et al. (2017)", "Harris et al. (2017)", "Trabucco and Zomer (2019)", "Abatzoglou et al. (2018)"), footnote_as_chunk = TRUE)
```
\elandscape
\newpage
