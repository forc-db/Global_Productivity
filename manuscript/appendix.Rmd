...
## Table S3. Signficance of relationships of forest C fluxes to MAT alone and in combination with MAP.
```{r eval = TRUE, echo=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
...
```{r echo=FALSE, fig.cap = "Figure S1: Maps showing distribution of samples for the nine forest C fluxes analyzed", out.height ='90%', fig.pos='H'}
...
```{r echo=FALSE, fig.align = "center", fig.cap = "Figure S2: Scatterplots and Pearson's R values for relationships among climate variables and latitude", out.height='90%', fig.pos='H'}
...
```{r echo=FALSE, fig.cap = "Figure S4: Individual plots of forest C fluxes in relation to mean annual climate, part 1.", out.height='90%', fig.pos='H'}
...
```{r echo=FALSE, fig.cap = "Figure S5: Individual plots of forest C fluxes in relation to mean annual climate, part 2.", out.height='90%', fig.pos='H'}
...
```{r echo=FALSE, fig.cap = "Figure S6: Individual plots of forest C fluxes in relation to mean climate seasonality, part 1.", out.height ='80%', fig.pos='H'}
...
```{r echo=FALSE, fig.cap = "Figure S7: Individual plots of forest C fluxes in relation to mean climate seasonality, part 2.", out.width ='80%', fig.pos='H'}
...
```{r echo=FALSE, fig.cap = "Figure S8: Growing season length-standardized forest C fluxes in relation to mean growing season climate, part 1.", out.width ='95%', fig.pos='H'}
...
```{r echo=FALSE, fig.cap = "Figure S9: Growing season length-standardized forest C fluxes in relation to mean growing season climate, part 2.", out.width ='95%', fig.pos='H'}
