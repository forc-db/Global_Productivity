  ...
  for (age in ages){
    for (response.variables.group in response.variables.groups){
      ...
      for(fixed.v in fixed.variables){
        ...
        png(file = paste0("C:/Users/becky/Dropbox (Smithsonian)/GitHub/Global_Productivity/manuscript/tables_figures/pairwise_comparisons_", number, ".png"), width = 3000, height = 2000, units = "px", res = 300)
