...
png(file = "C:/Users/becky/Dropbox (Smithsonian)/GitHub/Global_Productivity/manuscript/tables_figures/ratio_grid_plots.png", width = 3000, height = 2500, units = "px", res = 300)
