...
subsets <- c("ANPP_woody_and_foliage", "ANPP_woody_stem_and_foliage")
...
for (subset in subsets){
  ...
  tiff(file = paste0("C:/Users/banburymorganr/Dropbox (Smithsonian)/GitHub/Global_Productivity/results/figures/foliage_woody/boxplot_", subset, ".tiff"), width = 2255, height = 2000, units = "px", res = 300)
